...
#
# Runs the chosen algorithm using the pure-R prototype implementation
# (R_prototypes/), on the real simulated dataset, printing and plotting the
# full diagnostic battery (see plot_diagnostics.R). This is the R-only
...
set.seed(seed)
printf("Running %s (R prototype) for %s, seed=%d", algorithm, source_name, seed)
...
# Source the R prototype for the chosen algorithm
