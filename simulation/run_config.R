# simulation/run_config.R
#
# Edit this file directly on the cluster to control what simulation.R
# does. No need to re-send simulation.R for this -- it's sourced by
# simulation.R every time (direct run, batchtools job re-source, or
# check_progress.R/simulation_aggregate.R via SIMULATION_DEFS_ONLY).
#
# Just two variables:
